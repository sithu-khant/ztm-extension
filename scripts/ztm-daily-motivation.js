...
const quotesArray = [
    ...
    ['There is always a solution in programming', 'Andrei Neagoie'],
    ...
    ['If you don’t build your dream, someone will hire you to help build theirs.', 'Unknown'],
    ...
    ['If I fail more often than you, I win.', 'Unknown'],
    ...
    ['Above all, don’t fear difficult moments.', 'Unknown'],
    ['The whole secret of existence is to have no fear.', 'Buddha'],
    ['It only takes one person to make you happy and change your life: YOU', 'Unknown'],
    ...
    ['Don’t overestimate the world and underestimate yourself. You are better than you think. And you are not alone.', 'Unknown'],
    ...
    ['What would you do if you dont need money, and what did you do when you were 11? you have to be willing to work for free to do what you love. The insecure way is the secure way. Find a mentor...', 'Unknown'],
    ...
    ['Success consists of going from failure to failure with no loss of enthusiasm.', 'Unknown'],
    ...
    ['Always stay in touch with co workers and especially bosses.', 'Unknown'],
...
const dailyMotivationComponent = (quote, author) => {
    ...
    if (author == 'Unknown') {
        motivationP.innerHTML = `<p class='quote'>"${quote}"</p>`
    } else {
        motivationP.innerHTML = `<p class='quote'>"${quote}"</p><p class='dash-author'>&#x2015 <span class='author'>${author}</span></p>`  
    };
